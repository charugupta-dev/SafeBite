...
class Day1SummarizerScreen extends StatefulWidget {
  const Day1SummarizerScreen({super.key});

  @override
  State<Day1SummarizerScreen> createState() => _Day1SummarizerScreenState();
}

class _Day1SummarizerScreenState extends State<Day1SummarizerScreen> {
